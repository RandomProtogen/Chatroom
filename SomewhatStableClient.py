        ...
        while True:
            ...
            try:
                if not isinstance(self.receivedMessage, dict) or "type" not in self.receivedMessage:
                    ...
                    userListString = userListString.strip()
                    self.userList.append(userListString)
                    self.messagesdisplay.append(self.receivedMessage.get("content"))
                    ...
                    self.messagesdisplay.append(f"<i>{self.receivedMessage.get("username")} whispers to you: {self.receivedMessage.get("content")}")
